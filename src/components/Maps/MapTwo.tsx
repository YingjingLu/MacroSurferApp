...
import countryOne from '../../images/country/country-01.svg';
import countryTwo from '../../images/country/country-02.svg';
import countryThree from '../../images/country/country-03.svg';
import countryFour from '../../images/country/country-04.svg';
import countryFive from '../../images/country/country-05.svg';
import countrySix from '../../images/country/country-06.svg';
        ...
        <div className="mb-7.5 justify-between sm:flex">
          ...
          <div className="mb-2">
            <div className="relative z-20 inline-block rounded bg-gray-2 dark:bg-boxdark">
              ...
              >
                <option value="" className='dark:bg-boxdark'>Last 7 days</option>
                <option value="" className='dark:bg-boxdark'>Last 15 days</option>
              </select>
      ...
      <div className="space-y-2.5 border-t border-stroke p-4 dark:border-strokedark md:p-6 xl:p-7.5">
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            ...
            <p className="font-medium text-black dark:text-white">Canada</p>
          </div>
          <div className="relative block h-4.5 w-full rounded bg-meta-9 dark:bg-meta-4">
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            ...
            <p className="font-medium text-black dark:text-white">France</p>
          </div>
          <div className="relative block h-4.5 w-full rounded bg-meta-9 dark:bg-meta-4">
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            ...
            <p className="font-medium text-black dark:text-white">Italy</p>
          </div>
          <div className="relative block h-4.5 w-full rounded bg-meta-9 dark:bg-meta-4">
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            ...
            <p className="font-medium text-black dark:text-white">Australia</p>
          </div>
          <div className="relative block h-4.5 w-full rounded bg-meta-9 dark:bg-meta-4">
        ...
        <div className="items-center sm:flex">
          <div className="flex w-full max-w-42.5 items-center gap-3.5">
            ...
            <p className="font-medium text-black dark:text-white">India</p>
          </div>
          <div className="relative block h-4.5 w-full rounded bg-meta-9 dark:bg-meta-4">
